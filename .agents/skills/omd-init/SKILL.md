...
1. `.agents/data/reference-fingerprints.json` (사용자 프로젝트에 설치된 카탈로그 — 표준 경로)
...
추가 보조 파일 (있으면 같이 로드):
- `.agents/data/vocabulary.json` — controlled vocab axes/keywords
- `.agents/data/reference-tags.md` — human-readable keyword matrix
...
1. `.agents/data/references/<id>/DESIGN.md`
