              ...
              content: [
                {
                  ...
                  text: [
                    ...
                    "제공된 표본 규모, 필터, 근거만 사용하고 새로운 사실을 만들지 마세요.",
                    "수치(N, 응답 수, 평균, 점수, 퍼센트, 건수 등)는 본문에 직접 쓰지 말고 '대부분', '과반', '소수', '높은 편', '낮은 편', '응답이 적음' 같은 정성적 표현으로 바꿔 쓰세요.",
                    ...
                    "low sample 블록에는 caution을 반드시 작성하되 수치 없이 '응답이 적어 방향성 참고용' 형태로 쓰세요.",
