...
export class AdminPayloadMapper {
  ...
  toChoiceDistribution(row: RawChoiceDistribution): ChoiceDistribution {
    return {
      ...
      optionOrder: getFiniteNumber(row.option_order),
      rowValue: row.row_value ?? undefined,
      rowLabel: row.row_label ?? undefined,
      rowOrder: getFiniteNumber(row.row_order),
      columnValue: row.column_value ?? undefined,
      columnLabel: row.column_label ?? undefined,
      columnOrder: getFiniteNumber(row.column_order),
